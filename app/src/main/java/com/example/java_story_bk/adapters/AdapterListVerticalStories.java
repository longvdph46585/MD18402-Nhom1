...
public class AdapterListVerticalStories extends RecyclerView.Adapter<AdapterListVerticalStories.ViewHolder> {
    private ArrayList<StoryInfo> dataList;
    private Context context;
    public AdapterListVerticalStories(ArrayList<StoryInfo> list, Context context) {
        this.dataList = list;
